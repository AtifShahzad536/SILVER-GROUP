  ...
  return (
    <footer className="w-full bg-sports-secondary text-white border-t border-white/5">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-3 mb-6 group cursor-pointer">
              <div className="relative w-10 h-10 flex items-center justify-center overflow-hidden">
                <img src="/logo_silverstar1.png" alt="Silver Star Group" className="w-full h-full object-contain transition-transform duration-300 group-hover:scale-110" />
              </div>
      ...
      <div className="border-t border-white/5">
        <div className="w-full px-[2%] py-5 flex flex-col md:flex-row items-center justify-center md:justify-between gap-3 text-center md:text-left">
